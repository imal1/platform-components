 ...
 * @LastEditTime: 2022-02-19 23:45:58
 * @LastEditors: imali
 * @Description:
-->
<template>
  <div ref="p-date-picker">
    <el-date-picker
      ...
      v-on="$listeners"
    />
    <el-select v-if="type === 'quarter'" v-model="quarterModel" style="width: 100px">
      <el-option
...
<script>
import { defineComponent, ref, watch, inject, computed } from '@vue/composition-api'
